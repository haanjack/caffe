...
DenseImageDataLayer<Ftype, Btype>::~DenseImageDataLayer<Ftype, Btype>() {
  this->JoinPrefetchThread();
}

template <typename Ftype, typename Btype>
void DenseImageDataLayer<Ftype, Btype>::DataLayerSetUp(const vector<Blob*>& bottom,
...
template <typename Ftype, typename Btype>
void DenseImageDataLayer<Ftype, Btype>::ShuffleImages() {
...
template <typename Ftype, typename Btype>
void DenseImageDataLayer<Ftype, Btype>::InternalThreadEntry() {
  ...
  Ftype* prefetch_data = this->prefetch_data_.mutable_cpu_data();
  Ftype* prefetch_label = this->prefetch_label_.mutable_cpu_data();
  // datum scales
